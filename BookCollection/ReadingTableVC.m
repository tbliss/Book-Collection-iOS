...
@interface ReadingTableVC ()

@end

@implementation ReadingTableVC
...
- (void) refreshTable
{
    ...
    self.books = self.bookCollection.readingBooks;
...
{
    static NSString *CellIdentifier = @"ReadingBook";
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    } else if ([@"AddBook2" isEqualToString:segue.identifier]) {
